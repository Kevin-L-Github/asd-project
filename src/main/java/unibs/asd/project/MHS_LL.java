...
public class MHS_LL {
    ...
    private LinkedList<Hypothesis> current;
    ...
    public MHS_LL(boolean[][] instance) {
    ...
    public List<Hypothesis> run() {
        ...
        while (!current.isEmpty()) {
            ...
            LinkedList<Hypothesis> next = new LinkedList<>();

            ListIterator<Hypothesis> iterator = current.listIterator();
            while (iterator.hasNext()) {
                Hypothesis h = iterator.next();
                printStatusBar(iterator.previousIndex() + 1);
                if (check(h)) {
                    solutions.add(h);
                    iterator.remove();
                    ...
                    while (innerIterator.hasNext()) {
                        Hypothesis hyp = innerIterator.next();
    ...
    public List<Hypothesis> run(long timeoutMillis) {
        ...
        while (!current.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                Hypothesis h = iterator.next();
                printStatusBar(processed, DEPTH, startTime, timeoutNanos);
    ...
    private static LinkedList<Hypothesis> merge(Collection<Hypothesis> hypotheses, Collection<Hypothesis> toMerge) {
