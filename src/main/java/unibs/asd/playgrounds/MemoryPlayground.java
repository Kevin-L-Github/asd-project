...
public class MemoryPlayground { 
    ...
    public static void main(String[] args) { 
        ...
        int[] densities = { 5, 10, 25, 50, 75, 100 };
        ...
        System.out.printf("%-8s %-8s %-18s %-18s %-18s %-18s %-18s%n", "Size", "Density%", "RoaringHypothesis", "FastHypothesis", "BoolsHypothesis", "BitSetHypothesis", "SparseHypothesis");
        ...
        for (int size : sizes) { 
            ...
            for (int densityPercent : densities) { 
                ...
                System.out.printf("%-8d %-8d %-18d %-18d %-18d %-18d %-18d%n", size, densityPercent, sizeR, sizeF, sizeB, sizeBit, sizeS);
            }
            System.out.println();
        }
        System.out.println("\n=== ANALYSIS NOTES ===");
